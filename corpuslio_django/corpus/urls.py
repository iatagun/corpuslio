...
urlpatterns = [
    ...
    path('collections/<int:coll_id>/edit/', collection_views.edit_collection_view, name='edit_collection'),
    path('collections/<int:coll_id>/delete/', collection_views.delete_collection_view, name='delete_collection'),
